...
GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        if(myLocation != null){
            ...
            markerOption.position(new LatLng(currentLatitude, currentLongitude));
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        int persmissionLocation = ContextCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION);

        if(persmissionLocation== PackageManager.PERMISSION_GRANTED){
